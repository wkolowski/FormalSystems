...
| Add a1 a2 =>
  ...
  | ACond b1 a11 a12, ACond b2 a21 a22 =>
      ACond b1 (ACond b2 (Add a11 a21) (Add a11 a22)) (ACond b2 (Add a12 a21) (Add a12 a22))
  | ACond b1 a11 a12, a2 => ACond b1 (Add a11 a2) (Add a12 a2)
  | a1, ACond b2 a21 a22 => ACond b2 (Add a1 a21) (Add a1 a22)
  | a1, a2 => Add a1 a2
  end
| Sub a1 a2 => Sub a1 a2
| Mul a1 a2 => Mul a1 a2
...
| Eq a1 a2 =>
  match desugara a1, desugara a2 with
  | ACond b1 a11 a12, ACond b2 a21 a22 =>
      BCond b1 (BCond b2 (Eq a11 a21) (Eq a11 a22)) (BCond b2 (Eq a12 a21) (Eq a12 a22))
  | ACond b1 a11 a12, a2 => BCond b1 (Eq a11 a2) (Eq a12 a2)
  | a1, ACond b2 a21 a22 => BCond b2 (Eq a1 a21) (Eq a1 a22)
  | a1, a2 => Eq a1 a2
  end
| Le a1 a2 => Le a1 a2
